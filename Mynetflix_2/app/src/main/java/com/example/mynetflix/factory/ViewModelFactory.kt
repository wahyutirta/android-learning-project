    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            modelClass.isAssignableFrom(MovieVM::class.java) -> {
                MovieVM(mFilmRepository) as T
            }
            modelClass.isAssignableFrom(TvShowVM::class.java) -> {
                TvShowVM(mFilmRepository) as T
            }
            modelClass.isAssignableFrom(DetailMovieVM::class.java) -> {
                DetailMovieVM(mFilmRepository) as T
            }
            modelClass.isAssignableFrom(DetailTvShowVM::class.java) -> {
                DetailTvShowVM(mFilmRepository) as T
            }
